...
public class GildedRoseTest {
	...
	public void testWithNormalItemBeforeSellBuyDate() {
		...
		Assert.assertEquals(4, item.getDaysRemaining());
	}
	...
	public void testWithNormalItemOnSellDate() {
		...
		item.tick();
		Assert.assertEquals(8, item.getQuality());
		Assert.assertEquals(-1, item.getDaysRemaining());
	}
	...
	public void testWithNormalItemPastSellDate() {
		...
		item.tick();
		Assert.assertEquals(8, item.getQuality());
		Assert.assertEquals(-2, item.getDaysRemaining());
	}
	...
	public void testWithAgedBrieOnSellDate() {
		...
		item.tick();
		Assert.assertEquals(12, item.getQuality());
		Assert.assertEquals(-1, item.getDaysRemaining());
	}
	...
	public void testWithSulfurasBeforeSellDate() {
		...
		Assert.assertEquals(5, item.getDaysRemaining());
	}
	...
	public void testWithSulfurasOnSellDate() {
		...
		item.tick();
		Assert.assertEquals(80, item.getQuality());
		Assert.assertEquals(0, item.getDaysRemaining());
	}
	...
	public void testWithBackStagePasses_LongBeforeSellDate() {
		...
		item.tick();
		Assert.assertEquals(11, item.getQuality());
		Assert.assertEquals(10, item.getDaysRemaining());
	}
	...
	public void testWithBackStagePasses_MediumCloseToCloseToSellDate() {
		...
		item.tick();
		Assert.assertEquals(12, item.getQuality());
		Assert.assertEquals(9, item.getDaysRemaining());
	}
	...
	public void testWithBackStagePasses_VeryCloseToSellDate() {
		...
		item.tick();
		Assert.assertEquals(13, item.getQuality());
		Assert.assertEquals(4, item.getDaysRemaining());
	}
	...
	public void testWithConjured_OnSellDate() {
		...
		item.tick();
		Assert.assertEquals(6, item.getQuality());
		Assert.assertEquals(-1, item.getDaysRemaining());
	}
	...
	public void testWithConjured_AfterSellDate() {
		...
		item.tick();
		Assert.assertEquals(6, item.getQuality());
		Assert.assertEquals(-11, item.getDaysRemaining());
	}
